    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        for step, batch in enumerate(train_dataloader):
            ...
            logs = {
                ...
                "loss_w": model_losses_w_mean.detach().item(),
                "loss_w_ref": ref_losses_w_mean.detach().item(),
                "loss_w_diff": model_w_diff_mean.detach().item(),
                "loss_l": model_losses_l_mean.detach().item(),
                "loss_l_ref": ref_losses_l_mean.detach().item(),
                "loss_l_diff": model_l_diff_mean.detach().item(),
                "impl_acc": implicit_acc.detach().item(),
